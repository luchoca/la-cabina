        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center space-x-3">
              <div className={`w-26 h-26 ${currentTheme.icon} rounded-2xl flex items-center justify-center shadow-lg border-2 border-white/80 hover:scale-105 transition-transform duration-300`}>
